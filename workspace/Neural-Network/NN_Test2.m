...
input_train_matrix = input_train_matrix';
output_train_matrix = input_data_matrix(1:trainNum,end);
output_train_matrix = output_train_matrix';
input_test_matrix = input_data_matrix(trainNum+1:end,species_totalNum);
input_test_matrix = input_test_matrix';
